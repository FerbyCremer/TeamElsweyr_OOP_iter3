...
public class ActionPerformer {
    ...
    public void performAction(Player player, EntityAction entityAction){
        HashMap<Tile, Integer> tiles = entityAction.getAffectedTiles(entityContentMap.getTileOf(player), player.getDirection());
    ...
    public void performAction(Player player, TrapAction trapAction){
        HashMap<Tile, Integer> tiles = trapAction.getAffectedTiles(entityContentMap.getTileOf(player),player.getDirection());
        ArrayList<Point> points = new ArrayList<>();
        String name = null;
        for(Tile tile : tiles.keySet()){
            //This prob doesn't work.
